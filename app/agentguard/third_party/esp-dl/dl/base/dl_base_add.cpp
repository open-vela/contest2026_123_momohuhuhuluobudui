...
void c_impl_add_n_1(feature_t *output_ptr, feature_t *input0_ptr, feature_t *input1_ptr, void *args)
{
...
template <typename feature_t>
void c_impl_add_1_n(feature_t *output_ptr, feature_t *input0_ptr, feature_t *input1_ptr, void *args)
{
    elemwiseArgsType<feature_t> *elem_args = static_cast<elemwiseArgsType<feature_t> *>(args);
    int32_t length = elem_args->output_d0;
...
template <typename feature_t>
void c_impl_add_n_n(feature_t *output_ptr, feature_t *input0_ptr, feature_t *input1_ptr, void *args)
{
    elemwiseArgsType<feature_t> *elem_args = static_cast<elemwiseArgsType<feature_t> *>(args);
    int32_t length = elem_args->output_d0;
    int32_t temp = 0;
...
void elemwise_add(elemwiseArgsType<int8_t> *args)
{
    ...
    ImplFunc_t<int8_t, int8_t, int8_t> elemwise_func = c_impl_add_n_n<int8_t>;
...
void elemwise_add(elemwiseArgsType<int16_t> *args)
{
    ...
    ImplFunc_t<int16_t, int16_t, int16_t> elemwise_func = c_impl_add_n_n<int16_t>;
