...
// input0_ptr:vector, input1_ptr:scalar
template <>
void c_impl_sub_n_1<float>(float *output_ptr, float *input0_ptr, float *input1_ptr, void *args)
{
...
// input0_ptr:scalar, input1_ptr:vector
template <>
void c_impl_sub_1_n<float>(float *output_ptr, float *input0_ptr, float *input1_ptr, void *args)
{
    elemwiseArgsType<float> *elem_args = static_cast<elemwiseArgsType<float> *>(args);
    int32_t length = elem_args->output_d0;
...
// input0_ptr:vector, input1_ptr:vector
template <>
void c_impl_sub_n_n<float>(float *output_ptr, float *input0_ptr, float *input1_ptr, void *args)
{
    elemwiseArgsType<float> *elem_args = static_cast<elemwiseArgsType<float> *>(args);
    int32_t length = elem_args->output_d0;
    for (int i = 0; i < length; i++) {
...
{
    ImplFunc_t<float, float, float> elemwise_func = c_impl_sub_n_n<float>;

    if (args->input1_d0 == 1) {
        elemwise_func = c_impl_sub_n_1<float>;
    } else if (args->input0_d0 == 1) {
        elemwise_func = c_impl_sub_1_n<float>;
    }
